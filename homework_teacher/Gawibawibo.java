...
public class Gawibawibo {
	...
	private static void programExit(EmailChecker id) {
		JOptionPane.showMessageDialog(null, id.getid()+"님 프로그램을 종료 합니다.", "프로그램 종료", JOptionPane.INFORMATION_MESSAGE);
		System.exit(0);
	}
